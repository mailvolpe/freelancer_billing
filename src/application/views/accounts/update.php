...
<form method="post" action="" class="form-horizontal" autocomplete="off" role="form" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			...
			<?=bool_field('account_must_change_pass', set_value('account_must_change_pass', $item->account_must_change_pass));?>
		...
		<div class="col-sm-9 col-sm-offset-3 col-xs-12">
			...
			<div class="row">
				...
				<div class="col-xs-6">
					...
					<a class="btn btn-block btn-default" href="<?=base_url()?>accounts/view/<?=$item->account_id?>" >
